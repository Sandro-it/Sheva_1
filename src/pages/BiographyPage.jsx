      ...
      <div className={styles.biographyPage}>
        <div className={styles.textSection}>
          ...
          <p>
            ...
            творів, музики до теле-радіо вистав, художніх і анімаційних фільмів,
            а також естрадних пісень. Його музика для театру – це справжній
            культурний скарб. Юрій написав музику для понад 100 театральних
            вистав, співпрацюючи з провідними театрами України.
          </p>
          <p>
          ...
          <p>
            ...
            року", які сприяли успіху концертних турів по Канаді, США та Китаю.
            Балет "Те, що приніс вітер" (балетмейстер В. Литвинов) з успіхом був
            представлений на міжнародному фестивалі сучасної хореографії в
            Оттаві. У 2016 році відбулася прем'єра їхньої спільної роботи -
            кантати-балету "Кобзар".
          </p>

          <h2>Особисте життя та спадок</h2>
          <p>
            Юрій Шевченко був не лише талановитим композитором, але й людиною з
            глибоким розумінням театрального мистецтва. Його музика наповнює
            душі слухачів любов’ю, добром і світлом. Він завжди був присутній на
